...
public class MongoDataDriver implements DataDriver {
    ...
    MongoCollection<java.lang.Module> modules;
    ...
    public boolean init()  {
        ...
        try {
            ...
            modules = database.getCollection("modules", java.lang.Module.class);
    ...
    private ObjectId getModuleId(String moduleKey) {
        java.lang.Module module = modules.find(eq("key",moduleKey)).first();
        if (module != null) {
    ...
    public synchronized  String autoRegisterModule(String uc, List<String> chipsets) {
        ...
        java.lang.Module m = new Module(name, shortName, key.toString(), uc, lst);
        modules.insertOne(m);
